...
@section('panel_l_1_body')
    @include('includes._data_type_fields', [ 'dataType' => $dataType ,'dataTypeContent' => $dataTypeContent , 'isInclude' => true , 'fields' => ['title','title_color','isShowTitle','subtitle','mode','page','position'] ])
@stop
...
@section('panel_l_2_body')
    @include('includes._data_type_fields', [ 'dataType' => $dataType ,'dataTypeContent' => $dataTypeContent , 'isInclude' => true , 'fields' => ['url','url_txt','video','content','pic','alt'] ])
@stop
...
@section('panel_l_3_body')
    @include('includes._data_type_fields', [ 'dataType' => $dataType ,'dataTypeContent' => $dataTypeContent , 'isInclude' => false , 'fields' => ['title','subtitle','mode','sort','enabled','video','content','pic','alt','page','lang','position','title_pos','title_color','q_mode','i_mode','price','priceUnit','isBestPrice','icon','animation','animationDelay','url','url_txt','isShowTitle'] ])
@stop
...
@section('panel_r_1_body')
    @include('includes._data_type_fields', [ 'dataType' => $dataType ,'dataTypeContent' => $dataTypeContent , 'isInclude' => true , 'fields' => ['lang','sort','enabled'] ])
@stop
...
@section('panel_r_2_body')
    @include('includes._data_type_fields', [ 'dataType' => $dataType ,'dataTypeContent' => $dataTypeContent , 'isInclude' => true , 'fields' => ['title_pos','q_mode','i_mode','price','priceUnit','isBestPrice','icon','animation','animationDelay'] ])
@stop
